/* JS file with functions to control the display of the website and to access cameras array (parts edited due to security reasons)*/

//Function with display features of the webpage such as day of operation and password of selected server or camera
function display() {
...
//Function returning the name of the server of camera currently selected
function currCam(){
...
//Function opening the website of the camera. If the camera doesn't exist, it throws an error and alerts the user
function openWeb(){
    currDateTime();
    try{
