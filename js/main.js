//Function with display features of the webpage such as day of operation passed and password of inputted camera(some parts masked due to security reasons)
function display() {
...
$("#input-text").keyup(function(event){
    ...
    if (event.which >= 49 && event.which <=57 && event.ctrlKey){
